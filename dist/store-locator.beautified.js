...
*/
    ...
    storeLocator.Panel.prototype.init_ = function() {
        ...
        this.settings_.locationSearch && (this.locationSearch_ = $('<div class="location-search"><h4>' + this.settings_.locationSearchLabel + "</h4><input></div>"), 
        this.filter_.append(this.locationSearch_), "undefined" != typeof google.maps.places ? this.initAutocomplete_() : this.filter_.submit(function() {
        ...
        if (this.settings_.featureFilter) {
            ...
            for (var b = this.get("view").getFeatures().asList(), c = 0, d = b.length; c < d; c++) {
                var e = b[c], f = $('<input type="checkbox"/>');
                f.data("feature", e);
        ...
        this.settings_.directions && (this.directionsPanel_ = $('<div class="directions-panel"><form><input class="directions-to"/><input type="submit" value="Find directions"/><a href="#" class="close-directions">Close</a></form><div class="rendered-directions"></div></div>'), 
        this.directionsPanel_.find(".directions-to").attr("readonly", "readonly"), this.directionsPanel_.hide(), 
    ...
    storeLocator.Panel.prototype.selectedStore_changed = function() {
        ...
        if (b) {
            ...
            var c = a.get("view").getInfoWindow().getContent(), d = $("<a/>").text("Directions").attr("href", "#").addClass("action").addClass("directions"), e = $("<a/>").text("Zoom here").attr("href", "#").addClass("action").addClass("zoomhere"), f = $("<a/>").text("Street view").attr("href", "#").addClass("action").addClass("streetview");
            d.click(function() {
                a.showDirections();
                return !1;
            });
...
*/
    ...
    storeLocator.Store.prototype.generateFieldsHTML_ = function(a) {
        for (var b = [], c = 0, d = a.length; c < d; c++) {
            var e = a[c];
            this.props_[e] && (b.push('<div class="'), b.push(e), b.push('">'), b.push(this.props_[e]), 
            b.push("</div>"));
        }
        return b.join("");
    };
    storeLocator.Store.prototype.generateFeaturesHTML_ = function() {
        ...
        for (var b = this.features_.asList(), c = 0, d; d = b[c]; c++) a.push("<li>"), a.push(d.getDisplayName()), 
        a.push("</li>");
        a.push("</ul>");
        return a.join("");
    };
